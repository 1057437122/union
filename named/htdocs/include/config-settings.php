...
*/
$config["db_host"] = "172.16.0.6";			// hostname of the MySQL server
$config["db_name"] = "dns";				// database name
$config["db_user"] = "dns";				// MySQL user
$config["db_pass"] = "dns";				// MySQL password (if any)
